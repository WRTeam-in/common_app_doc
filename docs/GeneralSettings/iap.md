...
<div align="center">
  <img src={require('@site/static/img/iap/app_store_warning.png').default} alt="App Store Warning" style={{borderRadius: '8px'}} />
</div>
...
<div align="center" >
  <img src={require('@site/static/img/iap/app_store_agreements.png').default} alt="App Store Agreements" style={{borderRadius: '8px'}}/>
</div>
...
<div align="center">
  <img src={require('@site/static/img/iap/app_store_create_iap_1.webp').default} alt="App Store IAP Page" style={{borderRadius: '8px'}}/>
</div>
...
<div align="center">
  <img src={require('@site/static/img/iap/app_store_create_iap_2.webp').default} alt="App Store Create IAP" style={{borderRadius: '8px'}}/>
</div>
...
<div align="center">
  <img src={require('@site/static/img/iap/app_store_create_iap_3.webp').default} alt="App Store Create IAP" style={{borderRadius: '8px'}}/>
</div>
**App Store Localization** and **Review Information**
<div align="center">
  <img src={require('@site/static/img/iap/app_store_create_iap_4.webp').default} alt="App Store Create IAP" style={{borderRadius: '8px'}}/>
</div>
...
<div align="center">
  <img src={require('@site/static/img/iap/app_store_create_iap_5.webp').default} alt="App Store IAP List" style={{borderRadius: '8px'}}/>
</div>

After that go to **App Submission** page and scroll down to **In-App Purchases and Subscriptions** section.

<div align="center">
  <img src={require('@site/static/img/iap/app_store_create_iap_6.webp').default} alt="App Store Edit IAP" style={{borderRadius: '8px'}}/>
</div>
...
<div align="center">
  <img src={require('@site/static/img/iap/play_console_create_iap_1.webp').default} alt="Play Console Create IAP" style={{borderRadius: '8px'}}/>
</div>
...
<div align="center">
  <img src={require('@site/static/img/iap/play_console_create_iap_2.webp').default} alt="Play Console Add IAP Details" style={{borderRadius: '8px'}}/>
</div>
4. Save your changes and click **Activate** to make your in-app product available to users.
<div align="center">
  <img src={require('@site/static/img/iap/play_console_create_iap_3.webp').default} alt="Play Console Save and Activate IAP" style={{borderRadius: '8px'}}/>
</div>
